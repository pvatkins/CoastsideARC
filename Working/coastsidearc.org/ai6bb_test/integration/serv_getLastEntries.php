...
if (!$conn) {
    ...
    $sql = "SELECT * FROM (SELECT myindex, mydate, years, callsigns, `primary`, family, repeater, digipeater,\n"
    . "                           subtotal, paypalfee, clubreceives, total FROM `pp_tnx` ORDER BY myindex \n"
    . "                           DESC LIMIT 10) as `sho` ORDER BY myindex ASC;";
